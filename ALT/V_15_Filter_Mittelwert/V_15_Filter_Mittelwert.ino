...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    int leseZeit = 150;                     //Interval zum lesen vom Baro audio Vario, Standart(min) ist 150.
    int leseZeitBT = 100;                   //Interval zum lesen vom Baro fuer BT, Standart(min) ist 100.

    unsigned int konst_frqz = 150;          //Audio Frequez beim konstante Frequenz Einstellung.
    unsigned int max_frqz = 1800;           //Maximale Audio Frequenz beim variable Frequenz Einstellung.
    
    short bt_pin = 14;                       //Bluetooth Pin definieren. Fuer Leonardo 14. Fuer die Anderen 2.

    //short a_pin1 = 6;                       //Lautsprecher Pin definieren! <<= fuer normalen Mini Pro
    short a_pin1 = 9;                       //Lautsprecher Pin definieren! <<= fuer Leonardo
    //short a_pin1 = 5;                       //Lautsprecher Pin definieren! <<= fuer Ivkos Micro Vario

...
short startCH = 0;
int PinBT,  XOR, c, n;
float kal[3], Vario, VarioR, Mwert, dZeit, ZeitA, ZeitE, ZeitPipA, ZeitPipE, ZeitS;
float AvrgV[11] = {0.00, -0.58, 0.58, -0.58, 1.75, -1.75, 1.17, -0.58, 0.00, 0.00, 0.58};
//float AvrgV[19] = {0.00, -0.58, 0.58, -0.58, 1.75, -1.75, 1.17, -0.58, 0.00, 0.00, 0.58, -0.58, 0.00, 0.00, 0.00, 0.58, -1.17, 0.00, -0.58};
...
//BT umbenenen START
    if (PinBT == 1) 
    {
        ...
        Serial1.print("AT");
        delay(1500);
        Serial1.print("AT+NAMEIvkosVario");
        delay(500);
...
void SteigenBerechnen()
{
      ...
      // Steigwerte berechnen.
        Vario=((Hoehe - kal[0]) / (dZeit/1000000));
            VarioR=Vario;
        kal[0]=Hoehe;
